...
src = partial(
    Option,
    '--trydjango19', '--source', '--source-dir', '--source-directory',
    dest='src_dir',
    metavar='dir',
    default=src_prefix,
    help='Directory to check out editable projects into. '
    'The default in a virtualenv is "<venv path>/trydjango19". '
    'The default for global installs is "<current dir>/trydjango19".'
)
